...
3. `docs/doing/BEFORE_AFTER_기능명세.md` 머리 개정 이력 + **A1·A1-1**(9/25 개정 — LLM1 역할 축소 채택, "이대로 답변 받기" 버튼)
4. `docs/doing/v2격리_원복설계.md` — 격리 3층·클론 범위·원복 4단계·**브랜치가 못 지키는 것 4개**(§4)
5. `history/260924_Phase0_인프라이전_A1_12GB_ARM64_이관완료.md` · `history/260924_운영_RUNBOOK_인프라이전_후.md` — 서버 현황(단계 0.5 가 여기 위에 선다)
