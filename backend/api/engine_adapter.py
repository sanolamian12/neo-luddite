    ...
    props = {
        ...
        "etype": {
            ...
            "description": (
                ...
                "· 통신비: 휴대폰·인터넷 회선\n"
                "· 복리후생비: 직원 대상 헬스장·회원권·경조사·떡값 등 **급여가 아닌** 후생 혜택\n"
                "  (⚠️ 급여·인건비·상여금·퇴직금은 복리후생비가 **아닙니다** → '기타')\n"
                ...
                "— 예: **급여·인건비·상여금(가족·배우자 급여 포함)**·퇴직금·대손금·이자비용·세액공제·"
                "4대보험·부가세·노무분쟁 합의금·자산 폐기손실 같이 '지출 유형' 자체가 목록과 무관한 사안. "
                "비슷한 유형이 하나라도 있으면 그걸 고르세요."
            ),
        },
